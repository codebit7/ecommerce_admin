...
const Sidebar = () => {
  ...
  return (
    <div className={`d-flex flex-column p-3 bg-dark text-white ${isCollapsed ? "collapsed" : ""}`} style={{ width: isCollapsed ? "80px" : "250px", height: "100vh", transition: "width 0.3s" }}>
      ...
      <ul className="list-unstyled">
        ...
        <li className="mb-3">
          <div className="d-flex align-items-center justify-content-between" style={{ cursor: "pointer" }} onClick={() => setProductsOpen(!isProductsOpen)}>
        ...
        <li className="mb-3">
          <div className="d-flex align-items-center justify-content-between" style={{ cursor: "pointer" }} onClick={() => setCategoryOpen(!isCategoryOpen)}>
        ...
        <li className="mb-3">
          <div className="d-flex align-items-center justify-content-between" style={{ cursor: "pointer" }} onClick={() => setInventoryOpen(!isInventoryOpen)}>
        ...
        <li className="mb-3">
          <div className="d-flex align-items-center justify-content-between" style={{ cursor: "pointer" }} onClick={() => setOrdersOpen(!isOrdersOpen)}>
